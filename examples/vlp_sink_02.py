...
# Generated: Thu Sep 29 15:51:04 2016
##################################################
...
class vlp_sink_02(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.TX4_location = TX4_location = 1.2192, 0.9144, 0
        self.TX4_f = TX4_f = 400000
        self.TX3_location = TX3_location = 0.508, 0.9144, 0
        self.TX3_f = TX3_f = 200000
        self.TX2_location = TX2_location = 0.508, 0.3048, 0
        self.TX2_f = TX2_f = 300000
        self.TX1_location = TX1_location = 1.2192, 0.3048, 0
        ...
        self.analog_const_source_x_0_1 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, x)
        self.analog_const_source_x_0_0 = analog.sig_source_f(0, analog.GR_CONST_WAVE, 0, 0, y)
        ...
        self.connect((self.analog_const_source_x_0_1, 0), (self.blocks_float_to_complex_0_0, 0))    
        ...
        self.connect((self.blocks_float_to_complex_0_0, 0), (self.Position, 1))    
    ...
    def set_y(self, y):
        self.y = y
        self.analog_const_source_x_0_0.set_offset(self.y)
    ...
    def set_x(self, x):
        self.x = x
        self.analog_const_source_x_0_1.set_offset(self.x)
