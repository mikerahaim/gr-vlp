...
# Title: VLP Research
# Author: Richard McAllister, Jamesy Jean-Michel
# Generated: Sat Nov 12 14:35:00 2016
##################################################
...
class vlp_sink_03(gr.top_block, Qt.QWidget):
    ...
    def set_z_rx(self, z_rx):
        self.z_rx = z_rx
        self.vlp_proto_distance_ff_0_2.set_hrx(self.z_rx)
        self.vlp_proto_distance_ff_0_1.set_hrx(self.z_rx)
        self.vlp_proto_distance_ff_0_0.set_hrx(self.z_rx)
        self.vlp_proto_distance_ff_0.set_hrx(self.z_rx)
    ...
    def set_y(self, y):
        self.y = y
        self.analog_const_source_x_1.set_offset(self.y)
    ...
    def set_x(self, x):
        self.x = x
        self.analog_const_source_x_2.set_offset(self.x)
    ...
    def get_cpc_gain(self):
        return self.cpc_gain

    def set_cpc_gain(self, cpc_gain):
        self.cpc_gain = cpc_gain

    def get_Trx_filter(self):
        return self.Trx_filter

    def set_Trx_filter(self, Trx_filter):
...
def main(top_block_cls=vlp_sink_03, options=None):
